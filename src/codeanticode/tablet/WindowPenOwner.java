...
public class WindowPenOwner implements PenOwner {
  ...
  public void setPenManagerHandle(final PenManagerHandle penManagerHandle) {
    ...
    window.addMouseListener(new MouseAdapter() {
      ...
      public void mouseExited(MouseEvent ev) {
        ...
        // we would have to modify jpen internals to filter them out if
        // necessary...
  ...
  public Collection<PenProvider.Constructor> getPenProviderConstructors() {
    return Arrays.asList(new PenProvider.Constructor[] {
      // Note: do you need a newt mouse/keyboard provider (so that regular
      // newt mouse events/keyboard are fired as jpen events too)?
      new XinputProvider.Constructor(), new WintabProvider.Constructor(), 
